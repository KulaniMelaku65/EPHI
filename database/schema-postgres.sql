...
INSERT INTO regions (name, code, description, is_active) VALUES
('Addis Ababa', 'AA', 'Capital city region', true),
('Oromia', 'OR', 'Oromia regional state', true),
('Amhara', 'AM', 'Amhara regional state', true),
('Somali', 'SO', 'Somali regional state', true),
('Tigray', 'TI', 'Tigray regional state', true),
('SNNPR', 'SN', 'Southern Nations, Nationalities and Peoples Region', true),
('Dire Dawa', 'DD', 'Dire Dawa city administration', true),
('Afar', 'AF', 'Afar regional state', true),
('Benishangul-Gumuz', 'BG', 'Benishangul-Gumuz regional state', true),
('Gambela', 'GA', 'Gambela regional state', true),
('Harari', 'HA', 'Harari regional state', true) ON CONFLICT DO NOTHING;
...
('Dessie Hospital', 'Amhara', 'Hospital') ON CONFLICT DO NOTHING;
...
('Malaria Case Management', 'Diagnosis and treatment of malaria', 4, 'Disease Surveillance') ON CONFLICT DO NOTHING;
